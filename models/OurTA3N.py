...
class BaselineTA3N(nn.Module):
    ...
    def __init__(self, in_features_dim, num_classes, model_config):
        ...
        if 'trn' in self.model_config.cop_type:
            ...
            self.end_points[end_point_name] = nn.Sequential(self.FullyConnectedLayer(in_features_dim, in_features_dim, residual=True), self.FullyConnectedLayer(in_features_dim, out_features_dim_copnet))
